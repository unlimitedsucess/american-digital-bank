...
const transactions = [
  ...
  },
  {
    ...
    amount: 4250,
    type: "Debit",
    sender: "Aviation Services",
    description: "Flight maintenance",
    date: "2024-01-03",
    time: "07:14",
    status: "Completed",
    category: "Aviation",
      ...
      <DashboardSidebar>
        <div className="space-y-6">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <h1 className="text-2xl font-bold text-foreground mb-2">Withdrawal History</h1>
            <p className="text-muted-foreground">View all your debit / withdrawal transactions</p>
          </motion.div>
          ...
          >
              ...
              <CardContent className="p-4">
                <div className="text-center">
                  <p className="text-2xl font-bold text-red-600">
                    $ {debitTransactions.reduce((sum, t) => sum + t.amount, 0).toLocaleString()}
                  </p>
            ...
            <Card>
              <CardContent className="p-4">
                <div className="text-center">
                  <p className="text-2xl font-bold text-foreground">{debitTransactions.length}</p>
