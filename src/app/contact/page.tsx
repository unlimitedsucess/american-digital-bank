...
const contactInfo = [
  {
    icon: Phone,
    title: "Phone",
    details: ["Customer Service: 1-800-SKYFLEX", "International: +1-555-123-4567", "Business Banking: 1-800-BIZ-FLEX"],
  },
  {
    icon: Mail,
    title: "Email",
  ...
  },
  {
    icon: Clock,
    title: "Hours",
    details: ["Online Banking: 24/7", "Customer Service: 24/7", "Branch: Mon-Fri 9AM-5PM"],
  },
]
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl max-w-3xl mx-auto text-pretty">
                Get in touch with our team for personalized banking solutions and exceptional customer service
              </p>
            </motion.div>
          </div>
        </section>
                  ...
                  <CardContent className="p-0">
                    <div className="h-full min-h-[500px] bg-muted rounded-lg flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <h3 className="text-xl font-semibold mb-2">Find Our Locations</h3>
        ...
        <section className="py-16 bg-accent">
          <div className="container mx-auto px-4 text-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl font-bold text-accent-foreground mb-6">Need Immediate Assistance?</h2>
              <p className="text-xl text-accent-foreground mb-8 max-w-2xl mx-auto">
                For urgent banking matters, lost cards, or fraud reporting, contact us immediately
              </p>
